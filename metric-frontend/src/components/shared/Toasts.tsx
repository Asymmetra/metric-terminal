...
function ToastItem({ toast }: { toast: Toast }) {
  ...
  const bgColor = {
    success: "bg-[#0F1F18] border-metric-buy/30 border-l-metric-buy",
    error: "bg-[#1F0F12] border-metric-sell/30 border-l-metric-sell",
    info: "bg-[#1A1B20] border-metric-border border-l-metric-primary",
    loading: "bg-[#1A1B20] border-metric-border border-l-metric-primary",
  }[toast.type];
        ...
        {toast.txid && (
          <a
            ...
            className={clsx(
              ...
              toast.type === "success" ? "text-metric-buy/70" : "text-metric-sell/70"
            )}
          >
