...
export type SourceCategory =
  ...
  | "metric-ws"       // our backend's /ws — backend-relayed feeds
  | "metric-rest";    // our backend's /api/* — REST endpoints
...
export type SourceKind =
  ...
  | "metric-ws-candles"
  // ── Ember REST ──────────────────────────────────────────────────────
  | "metric-rest-markets"     // GET /api/markets
  | "metric-rest-orderbook"   // GET /api/orderbook/{symbol}
  | "metric-rest-candles"     // GET /api/candles/{symbol}
  | "metric-rest-health-memory" // GET /health/memory
  | "metric-rest-health-relay"  // GET /health/relay
  | "metric-rest-health-ws";    // GET /health/ws
