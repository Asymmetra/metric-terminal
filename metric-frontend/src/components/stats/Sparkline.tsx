...
export function Sparkline({
  ...
  if (values.length === 0) {
    return (
      <div
        className="flex items-center justify-center border border-dashed border-metric-border/40 font-mono text-[10px] text-text-secondary/40"
        style={{ width, height }}
      >
        no samples yet
      </div>
