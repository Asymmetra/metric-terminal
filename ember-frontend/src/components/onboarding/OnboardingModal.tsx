            ...
            <div className="w-full max-w-[440px] border border-ember-border bg-surface-l1 shadow-[0_16px_64px_rgba(0,0,0,0.6)]">
              ...
              <div className="flex flex-col gap-4 px-5 py-5">
                ...
                <div
                  ...
                  className="flex border border-ember-border bg-surface-l2 p-0.5"
                >
                ...
                <div className="border-t border-ember-border/60 pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      disabled={submitting}
                      className="flex items-center justify-center gap-2 border border-ember-border bg-transparent px-3 py-2 font-mono text-[10px] uppercase tracking-wider text-text-secondary/80 transition-colors hover:border-ember-border hover:bg-surface-l2 hover:text-text-primary"
                    >
                      Browse anyway
                    </button>
                    <button
