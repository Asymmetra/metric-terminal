...
export function FundingChart({ authority }: FundingChartProps) {
  ...
  return (
    <div className="flex h-full flex-col border border-ember-border bg-surface-l1">
      <div className="flex items-center justify-between border-b border-ember-border px-4 py-2">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="flex items-center gap-1">
              ...
              <span className={clsx("font-mono text-[10px]", lastFunding >= 0 ? "text-ember-green" : "text-ember-red")}>
