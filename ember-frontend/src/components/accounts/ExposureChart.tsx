...
const RING_COLORS = [
  "#FF5500", "#2EE29B", "#8B5CF6", "#F23B4E", "#3B82F6",
    ...
    <div className="border border-ember-border bg-surface-l1 p-4">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative flex-shrink-0">
          ...
          />
          <div className="absolute inset-3 flex items-center justify-center rounded-full bg-surface-l1">
            ...
            <div key={e.symbol} className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span
                  className={clsx(
                    "font-mono text-[9px]",
                    e.side === "Long" ? "text-ember-green" : "text-ember-red"
                  )}
                >
                  {e.side}
                </span>
