# Rust SDK - Crate Architecture

Solana SDK for the Phoenix perpetuals exchange. Structured as a workspace with specialized crates for types, instruction building, math, and higher-level clients.
...
│   │   ├── send_limit_order.rs
│   │   ├── isolated_market_order_client.rs
│   │   ├── isolated_market_order_server.rs
│   │   ├── isolated_limit_order.rs
│   │   ├── cancel_order.rs
│   │   ├── deposit_funds.rs
│   │   ├── register_trader.rs
...
├── sdk/AGENTS.md           # Architecture guide for SDK clients
└── types/                  # phoenix-types crate
    ...
    └── src/
        ...
        ├── ix.rs           # Server-side instruction request types
...
High-level client with WebSocket and HTTP support, automatic reconnection, and transaction building:
...
See [`sdk/AGENTS.md`](./sdk/AGENTS.md) for detailed architecture of the three-layer client hierarchy.
