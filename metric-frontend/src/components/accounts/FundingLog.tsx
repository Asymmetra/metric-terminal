...
export function FundingLog({ authority }: FundingLogProps) {
  ...
  return (
    <div className="border border-metric-border bg-surface-1">
                ...
                >
                  ...
                  <td
                    className={clsx(
                      ...
                      payment > 0 ? "text-metric-buy" : payment < 0 ? "text-metric-sell" : "text-text-secondary/50"
                    )}
                  >
                  ...
                  <td className="px-3 py-1.5">
                    <span
                      className={clsx(
                        "font-mono text-[10px]",
                        /long|buy|bid/i.test(side) ? "text-metric-buy" : "text-metric-sell"
                      )}
                    >
                      {side}
                    </span>
      ...
      {/* Summary row */}
      <div className="flex items-center justify-between border-t border-metric-border px-3 py-2">
        ...
        <span
          className={clsx(
            ...
            netFunding > 0 ? "text-metric-buy" : netFunding < 0 ? "text-metric-sell" : "text-text-secondary"
          )}
        >
