...
function ColHeader({ label, tooltip, tooltipTitle, align = "right" }: { label: string; tooltip: string; tooltipTitle?: string; align?: "left" | "right" | "center" }) {
  ...
  return (
    <th className={clsx("px-3 py-1.5 font-normal uppercase tracking-wider", `text-${align}`)}>
      ...
      {show && (
        <div
          className="fixed z-[200] w-56 rounded border border-metric-border bg-[#1A1B20] px-3 py-2.5 text-left text-[10px] normal-case tracking-normal text-text-secondary/90 leading-relaxed shadow-[0_8px_32px_rgba(0,0,0,0.6)] pointer-events-none"
...
export function Positions() {
  ...
  // TradeDetailPanel). See metric-frontend/src/hooks/useLivePositionPnl.ts.
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      {/* Tab bar */}
      <div className="flex items-center border-b border-metric-border">
        {TABS.map((tab) => (
          <button
            key={tab.key}
          ...
          >
            {tab.label}
            {activeTab === tab.key && (
              <div className="absolute bottom-0 left-0 right-0 h-px bg-metric-primary" />
            )}
          </button>
        ))}
                    ...
                    <th className="px-3 py-1.5 text-right font-normal uppercase tracking-wider">
                      <button
                        ...
                        className={clsx(
                          ...
                          closingAll ? "text-text-secondary/50" : "text-metric-sell/70 hover:text-metric-sell"
                        )}
                      >
                    ...
                    return (
                      <tr
                        ...
                        className={clsx(
                          ...
                          isLiquidatable
                            ? "bg-metric-sell/10 hover:bg-metric-sell/15"
                            : isUnhealthy
                      ...
                      >
                        <td className="px-3 text-text-primary">
                          {isUnhealthy && (
                            <span
                              className={clsx(
                                "mr-1.5 inline-block",
                                isLiquidatable ? "text-metric-sell" : "text-yellow-500"
                              )}
                        ...
                        <td className={clsx("px-3 font-medium", isLong ? "text-metric-buy" : "text-metric-sell")}>
                        ...
                        <td className={clsx("px-3 text-right font-medium", pos.unrealized_pnl >= 0 ? "text-metric-buy" : "text-metric-sell")}>
                          {pos.unrealized_pnl >= 0 ? "+" : ""}{formatUsd(pos.unrealized_pnl)}
                        </td>
                        <td className={clsx("px-3 text-right font-mono text-[10px]", roi >= 0 ? "text-metric-buy" : "text-metric-sell")}>
                          {roi >= 0 ? "+" : ""}{roi.toFixed(1)}%
                        </td>
                        <td className="px-3 text-right font-mono text-[10px] text-metric-sell/80">
                          {liqPrice != null ? `$${formatPrice(liqPrice)}` : "—"}
                        </td>
                        <td className={clsx(
                          "px-3 text-right font-mono text-[10px]",
                          liqDistPct == null ? "text-text-secondary/50"
                            : liqDistPct < 5 ? "text-metric-sell"
                            : liqDistPct < 10 ? "text-yellow-500"
                            : "text-metric-buy"
                        )}>
                          {liqDistPct != null ? `${liqDistPct.toFixed(1)}%` : "—"}
                        </td>
                        <td className="px-3 text-right font-mono text-[10px] text-metric-primary">
                        ...
                        <td className="px-3 text-center">
                          <span className={clsx(
                            ...
                            pos.margin_mode === "isolated"
                              ? "text-metric-primary bg-metric-primary/10"
                              : "text-text-secondary/60 bg-surface-2"
                          )}>
                          ...
                          {pos.margin_mode === "isolated" && (
                            <button
                              ...
                              className="ml-1 font-mono text-[9px] text-text-secondary/60 hover:text-metric-primary transition-colors"
                            >
                              +/−
                            </button>
                          )}
                          ...
                          {pos.tp_price != null ? (
                            ...
                            >
                              {cancellingLeg?.startsWith(posKey) ? (
                                ...
                                <>
                                  <span className="text-metric-buy group-hover/tp:line-through group-hover/tp:text-text-secondary/60 transition-colors">
                                    ${formatPrice(pos.tp_price)}
                                  </span>
                                  <span className="hidden group-hover/tp:inline text-metric-sell/70 text-[9px]">✕</span>
                                </>
                              )}
                            </span>
                          ) : (
                          ...
                          {pos.sl_price != null ? (
                            ...
                            >
                              {cancellingLeg?.startsWith(posKey) ? (
                                ...
                                <>
                                  <span className="text-metric-sell group-hover/sl:line-through group-hover/sl:text-text-secondary/60 transition-colors">
                                    ${formatPrice(pos.sl_price)}
                                  </span>
                                  <span className="hidden group-hover/sl:inline text-metric-sell/70 text-[9px]">✕</span>
                                </>
                              )}
                            </span>
                          ) : (
                          ...
                          <button
                            ...
                            className={clsx(
                              ...
                              closingSymbol === pos.symbol || closingAll
                                ...
                                : "text-metric-sell/70 hover:text-metric-sell"
                            )}
                          >
                ...
                <tbody>
                  {allOrders.map((order) => {
                    ...
                    return (
                      <tr
                        key={key}
                        className="font-mono text-[11px] transition-colors hover:bg-surface-2/30"
                        style={{ height: "28px" }}
                      >
                        <td className="px-3 text-text-primary">{order.symbol}-PERP</td>
                        <td className={clsx("px-3 font-medium", isBid ? "text-metric-buy" : "text-metric-sell")}>
                          {isBid ? "BUY" : "SELL"}
                        </td>
                  ...
                  {tradeHistory.map((trade) => {
                    ...
                    return (
                      <tr
                        ...
                        className="cursor-pointer font-mono text-[11px] transition-colors hover:bg-surface-2/30"
                        style={{ height: "28px" }}
                      >
                        ...
                        <td className="px-3 text-center">
                          <a
                            ...
                            className="text-metric-primary/60 hover:text-metric-primary transition-colors"
                          >
        ...
        <div className="flex flex-col gap-3 p-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono text-[11px] text-metric-primary">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                autoFocus
                className="w-full border border-metric-border bg-surface-2 py-2.5 pl-3 pr-16 font-mono text-sm text-text-primary placeholder:text-text-secondary/40 focus:border-metric-primary/60 focus:outline-none transition-colors"
              />
          ...
          <div className="flex gap-2">
            {[10, 50, 100, 500].map((val) => (
              <button
                ...
                className="flex-1 border border-metric-border/50 py-1 font-mono text-[10px] text-text-secondary/60 transition-colors hover:border-metric-primary/30 hover:text-text-secondary"
              >
                ${val}
              </button>
            ))}
          ...
          {error && (
            <div className="font-mono text-[10px] text-metric-sell">{error}</div>
          )}
          ...
          <button
            ...
            className={clsx(
              ...
              mode === "add"
                ...
                : "bg-surface-2 border border-metric-primary text-metric-primary hover:bg-metric-primary/10",
