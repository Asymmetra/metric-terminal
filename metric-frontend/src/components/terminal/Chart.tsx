        ...
        const markers = trades
          ...
          .map((t: any) => {
            ...
            const color = longSide
              ? opening ? COLORS.emberGreen : "rgba(34,211,238,0.6)"
              : opening ? COLORS.emberRed : "rgba(249,115,22,0.6)";
        ...
        {chartError && (
          <div className="absolute inset-0 flex items-center justify-center bg-surface-1/80">
            <div className="flex flex-col items-center gap-2">
              <span className="font-mono text-[11px] text-metric-sell">{chartError}</span>
              <button
