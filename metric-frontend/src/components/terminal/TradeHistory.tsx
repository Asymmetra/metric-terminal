          ...
          return (
            <div key={`${trade.timestamp}-${trade.price}-${trade.size}-${i}`}>
              <div
                ...
                className={clsx(
                  "grid cursor-pointer grid-cols-3 px-2 font-mono leading-none transition-colors hover:bg-surface-2/40 trade-slide-in",
                ...
                style={{
                  ...
                  backgroundColor: isLarge
                    ? trade.side === "bid" ? "rgba(34,211,238,0.06)" : "rgba(249,115,22,0.06)"
                    : undefined,
                }}
              >
                <span className={trade.side === "bid" ? "text-metric-buy" : "text-metric-sell"}>
              ...
              {showGap && trades[i + 1] && (
                <div className="flex items-center gap-2 px-2 py-0.5">
                  <div className="flex-1 h-px bg-metric-border/40" />
