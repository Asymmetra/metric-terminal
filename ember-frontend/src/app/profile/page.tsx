...
function DisconnectedState() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-ember-black px-4">
      ...
      <p className="font-mono text-[11px] text-text-secondary/60">
        Connect a wallet to see your trading profile, or pass <span className="text-ember-orange">?trader=&lt;pubkey&gt;</span> to view someone else&apos;s.
      </p>
      <WalletButton />
      <Link
        href="/terminal"
