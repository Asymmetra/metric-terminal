                ...
                >
                  ...
                  <td className="px-3 py-1.5">
                    <span
                      className={clsx(
                        ...
                        isBuy ? "text-ember-green" : "text-ember-red"
                      )}
                    >
                      {isBuy ? "Buy" : "Sell"}
                    </span>
                  ...
                  <td
                    className={clsx(
                      ...
                      pnl > 0 ? "text-ember-green" : pnl < 0 ? "text-ember-red" : "text-text-secondary/50"
                    )}
                  >
                  ...
                  <td className="px-3 py-1.5 text-center">
                    {sig ? (
                      <a
                        ...
                        className="font-mono text-[10px] text-ember-orange/70 hover:text-ember-orange transition-colors"
                      >
                        View
                      </a>
                    ) : (
