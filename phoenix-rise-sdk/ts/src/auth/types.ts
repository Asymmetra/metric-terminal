...
export type RiseAuthMode = "auth_enabled" | "auth_enabled_lazily";
export type RiseSessionControl = "managed" | "external";
export type RiseWsAuthMode = "auto" | "authenticated" | "anonymous";
export type RiseAuthBootstrapReason =
  | "missing_session"
  | "expired_session"
  | "unauthorized";

export interface RiseAuthBootstrapper {
  bootstrap(
    reason: RiseAuthBootstrapReason
  ): Promise<AuthSession | AuthSessionSnapshot | null>;
}
...
export interface RiseAuthConfig {
  ...
  bootstrapper?: RiseAuthBootstrapper;
  wsAuthMode?: RiseWsAuthMode;
}
