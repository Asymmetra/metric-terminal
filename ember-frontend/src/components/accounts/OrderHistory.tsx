...
export function OrderHistory({ authority }: OrderHistoryProps) {
  ...
  return (
    <div className="border border-ember-border bg-surface-l1">
      {/* Filter tabs */}
      <div className="flex border-b border-ember-border">
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead>
            <tr className="border-b border-ember-border/60">
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-1.5">
                    <span className={clsx("font-mono text-[10px] uppercase", isBuy ? "text-ember-green" : "text-ember-red")}>
                      {isBuy ? "Buy" : "Sell"}
                    </span>
                  </td>
