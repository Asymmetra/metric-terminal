...
// Cool palette: sky / cyan / soft slate. No fire colors.
const SPARK_COLORS = ["#22D3EE", "#0EA5E9", "#7DD3FC"];
const EMBER_COLORS = ["#0EA5E9", "#38BDF8", "#67E8F9"];
const ASH_COLORS = ["#0EA5E966", "#22D3EE44", "#475569AA"];
...
export function MetricParticles() {
  ...
  useEffect(() => {
    ...
    function drawHeatGlow() {
      ...
      gradient.addColorStop(0.3, "rgba(34,211,238,0.05)");
