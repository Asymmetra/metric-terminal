    ...
    (async () => {
      ...
      const chart = createChart(containerRef.current, {
        ...
        crosshair: {
          ...
          vertLine: { color: "rgba(255,85,0,0.3)", width: 1, style: LineStyle.Dashed, labelBackgroundColor: COLORS.emberOrange },
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const series = chartRef.current.addAreaSeries({
        ...
        topColor: overlay === "drawdown" ? "rgba(242,59,78,0.28)" : "rgba(46,226,155,0.28)",
        bottomColor: overlay === "drawdown" ? "rgba(242,59,78,0.02)" : "rgba(46,226,155,0.02)",
        lineWidth: 2,
